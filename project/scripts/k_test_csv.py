...
if __name__ == '__main__':
    ...
    axis[0].plot(exp4[0][:40000],exp4[1][:40000],label="(k1,k2)=(0.5,1)",color = "orange")
    ...
    axis[1].plot(exp4[0][:40000],exp4[2][:40000],label="(k1,k2)=(0.5,1)",color = "orange")
    ...
    axis[0].plot(exp1[0][:40000],exp4[5][:40000],label="(k1,k2)=(0.5,1)",color = "orange")
    axis[0].plot(exp4[0][:40000],exp1[4][:40000],label="Upper boundary")
    axis[0].set_xlabel("Time in seconds")
    ...
    axis[1].plot(exp1[0][:40000],exp4[8][:40000],label="(k1,k2)=(0.5,1)",color = "orange")
    axis[1].plot(exp4[0][:40000],exp1[7][:40000],label="Lower boundary")
    axis[1].set_xlabel("Time in seconds")
    ...
    axis[0].plot(exp4[0][:40000],exp4[9][:40000],label="(k1,k2)=(0.5,1)",color = "orange")
    axis[0].set_xlabel("Time in seconds")
    ...
    axis[1].plot(exp4[0][:40000],exp4[10][:40000],label="(k1,k2)=(0.5,1)",color = "orange")
    axis[1].set_xlabel("Time in seconds")
