...
if __name__ == '__main__':
    ...
    10:angle_list
    """
    with open("csv_files/k1_0.3_k2_1_decentralized_follow_figure8.csv") as f:
        exp1 = list(csv.reader(f,delimiter=","))

    with open("csv_files/k1_0.3_k2_1_decentralized_lidar_only_figure8.csv") as f:
        exp2 = list(csv.reader(f,delimiter=","))

    with open("csv_files/k1_0.3_k2_1_decentralized_filtered_figure8.csv") as f:
        exp3 = list(csv.reader(f,delimiter=","))

    with open("csv_files/k1_0.3_k2_1_decentralized_complete_figure8.csv") as f:
    ...
    9:tb1_ylist,
    """
    with open("csv_files/k1_0.3_k2_1_decentralized_follow_figure8_position.csv") as f:
        exp1_pos = list(csv.reader(f,delimiter=","))

    with open("csv_files/k1_0.3_k2_1_decentralized_lidar_only_figure8_position.csv") as f:
        exp2_pos = list(csv.reader(f,delimiter=","))

    with open("csv_files/k1_0.3_k2_1_decentralized_filtered_figure8_position.csv") as f:
        exp3_pos = list(csv.reader(f,delimiter=","))

    with open("csv_files/k1_0.3_k2_1_decentralized_complete_figure8_position.csv") as f:
 ...
 #Starting at 200, this is 20 seconds. Take the mean and std.dev
    ...
    print("Distance error mean 1:",np.mean(exp1[5][200:1280]))
    print("Distance error std.dev 1:",np.std(exp1[5][200:1280]))

    print("Distance error mean 2:",np.mean(exp2[5][200:1280]))
    print("Distance error std.dev 2:",np.std(exp2[5][200:1280]))

    print("Distance error mean 3:",np.mean(exp3[5][200:1280]))
    print("Distance error std.dev 3:",np.std(exp3[5][200:1280]))

    print("Distance error mean 4:",np.mean(exp4[5][200:1280]))
    print("Distance error std.dev 4:",np.std(exp4[5][200:1280]))

    #Angular error mean and std dev
    print("Angular error mean 1:",np.mean(exp1[8][200:1280]))
    print("Angular error 1 std.dev:",np.std(exp1[8][200:1280]))

    print("Angular error mean 2:",np.mean(exp2[8][200:1280]))
    print("Angular error std.dev 2:",np.std(exp2[8][200:1280]))

    print("Angular error mean 3:",np.mean(exp3[8][200:1280]))
    print("Angular error std.dev 3:",np.std(exp3[8][200:1280]))

    print("Angular error mean 4:",np.mean(exp4[8][200:1280]))
    print("Angular error std.dev 4:",np.std(exp4[8][200:1280]))   

    #Distance mean and std. dev
    print("Distance mean 1:",np.mean(exp1[9][200:1280]))
    print("Distance std.dev 1:",np.std(exp1[9][200:1280]))

    print("Distance mean 2:",np.mean(exp2[9][200:1280]))
    print("Distance std.dev 2:",np.std(exp2[9][200:1280]))

    print("Distance mean 3:",np.mean(exp3[9][200:1280]))
    print("Distance std.dev 3:",np.std(exp3[9][200:1280]))

    print("Distance mean 4:",np.mean(exp4[9][200:1280]))
    print("Distance std.dev 4:",np.std(exp4[9][200:1280]))

    #Angle mean and std. dev
    print("Angle mean 1:",np.mean(exp1[10][200:1280]))
    print("Angle std.dev 1:",np.std(exp1[10][200:1280]))

    print("Angle mean 2:",np.mean(exp2[10][200:1280]))
    print("Angle std.dev 2:",np.std(exp2[10][200:1280]))

    print("Angle mean 3:",np.mean(exp3[10][200:1280]))
    print("Angle std.dev 3:",np.std(exp3[10][200:1280]))

    print("Angle mean 4:",np.mean(exp4[10][200:1280]))
    print("Angle std.dev 4:",np.std(exp4[10][200:1280]))

    #Plotting velocity and angular velocity error
    figure, axis = plt.subplots(1, 2)
    axis[0].plot(exp1[0][:1280],vel_error1[:1280],label="Camera-only",color = "blue")
    axis[0].plot(exp2[0][:1280],vel_error2[:1280],label="Lidar-only",color = "red")
    axis[0].plot(exp3[0][:1280],vel_error3[:1280],label="Filtered",color = "green")
    axis[0].plot(exp4[0][:1280],vel_error4[:1280],label="Complete",color = "orange")
    axis[0].set_xlabel("Time in seconds")
    axis[0].set_ylabel("Velocity error in m/s")
    axis[0].set_title("Velocity error")
    axis[0].legend()
    
    axis[1].plot(exp1[0][:1280],ang_vel_error1[:1280],label="Camera-only",color = "blue")
    axis[1].plot(exp2[0][:1280],ang_vel_error2[:1280],label="Lidar only",color = "red")
    axis[1].plot(exp3[0][:1280],ang_vel_error3[:1280],label="Filtered",color = "green")
    axis[1].plot(exp4[0][:1280],ang_vel_error4[:1280],label="Complete",color = "orange")
    ...
    axis[0].plot(exp4[0][:1280],exp4[5][:1280],label="Complete",color = "orange")
    axis[0].plot(exp1[0][:1280],exp1[4][:1280],label="Upper boundary")
    axis[0].set_xlabel("Time in seconds")
    ...
    axis[1].plot(exp4[0][:1280],exp4[8][:1280],label="Complete",color = "orange")
    axis[1].plot(exp1[0][:1280],exp1[7][:1280],label="Lower boundary")
    axis[1].set_xlabel("Time in seconds")
    ...
    figure, axis = plt.subplots(1, 2)
    axis[0].plot(exp1[0][:1280],exp1[9][:1280],label="Camera-only",color = "blue")
    axis[0].plot(exp2[0][:1280],exp2[9][:1280],label="Lidar-only",color = "red")
    axis[0].plot(exp3[0][:1280],exp3[9][:1280],label="Filtered",color = "green")
    axis[0].plot(exp4[0][:1280],exp4[9][:1280],label="Complete",color = "orange")
    axis[0].set_xlabel("Time in seconds")
    axis[0].set_ylabel("Relative distance in m")
    axis[0].set_title("Distance between leader and follower")
    axis[0].legend()

    axis[1].plot(exp1[0][:1280],exp1[10][:1280],label="Camera-only",color = "blue")
    axis[1].plot(exp2[0][:1280],exp2[10][:1280],label="Lidar-only",color = "red")
    axis[1].plot(exp3[0][:1280],exp3[10][:1280],label="Filtered",color = "green")
    axis[1].plot(exp4[0][:1280],exp4[10][:1280],label="Complete",color = "orange")
    axis[1].set_xlabel("Time in seconds")
