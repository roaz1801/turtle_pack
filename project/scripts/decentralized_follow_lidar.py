...
class move_bot:
    ...
    def control(self,d,beta,t):
        ...
        print(d)
        print(beta)
        #print("Lidar distance",self.lidar_dist)
        #Variables
        d_desired = 0.75
        d_col = 0.2*d_desired
...
if __name__ == '__main__':
    ...
    while not rospy.is_shutdown():
        try:
            ...
            #transform_detected = 1
        except(tf2_ros.LookupException, tf2_ros.ConnectivityException, tf2_ros.ExtrapolationException):
            #print("Tranform does not exist")
            #transform_detected = 0
            rate.sleep()
            continue
    ...
    #plt.plot(time_list,epsilon_list)
    #plt.show()
