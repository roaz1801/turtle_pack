...
if __name__ == '__main__':
    ...
    12:angle_list
    """
    with open("csv_files/k1_0.1_k2_0.45_vision_follow_circle.csv") as f:
        exp1 = list(csv.reader(f,delimiter=","))

    with open("csv_files/k1_0.1_k2_0.45_vision_lidar_only_circle.csv") as f:
        exp2 = list(csv.reader(f,delimiter=","))

    with open("csv_files/k1_0.1_k2_0.45_vision_filtered_circle.csv") as f:
        exp3 = list(csv.reader(f,delimiter=","))

    with open("csv_files/k1_0.1_k2_0.45_vision_complete_circle.csv") as f:
    ...
    9:tb1_ylist,
    """
    with open("csv_files/k1_0.1_k2_0.45_vision_follow_circle_position.csv") as f:
        exp1_pos = list(csv.reader(f,delimiter=","))

    with open("csv_files/k1_0.1_k2_0.45_vision_lidar_only_circle_position.csv") as f:
        exp2_pos = list(csv.reader(f,delimiter=","))

    with open("csv_files/k1_0.1_k2_0.45_vision_filtered_circle_position.csv") as f:
        exp3_pos = list(csv.reader(f,delimiter=","))

    with open("csv_files/k1_0.1_k2_0.45_vision_complete_circle_position.csv") as f:
 ...
 #Starting at 200, this is 20 seconds. Take the mean and std.dev
    ...
    print("Image coordinate n error mean 1:",np.mean(exp1[5][200:3000]))
    print("Image coordinate n error std.dev 1:",np.std(exp1[5][200:3000]))

    print("Image coordinate n error mean 2:",np.mean(exp2[5][200:3000]))
    print("Image coordinate n error std.dev 2:",np.std(exp2[5][200:3000]))

    print("Image coordinate n error mean 3:",np.mean(exp3[5][200:3000]))
    print("Image coordinate n error std.dev 3:",np.std(exp3[5][200:3000]))

    print("Image coordinate n error mean 4:",np.mean(exp4[5][200:3000]))
    print("Image coordinate n error std.dev 4:",np.std(exp4[5][200:3000]))

    #Angular error mean and std dev
    print("Image coordinate m error mean 1:",np.mean(exp1[8][200:3000]))
    print("Image coordinate m error std.dev 1:",np.std(exp1[8][200:3000]))

    print("Image coordinate m error mean 2:",np.mean(exp2[8][200:3000]))
    print("Image coordinate m error std.dev 2:",np.std(exp2[8][200:3000]))

    print("Image coordinate m error mean 3:",np.mean(exp3[8][200:3000]))
    print("Image coordinate m error std.dev 3:",np.std(exp3[8][200:3000]))

    print("Image coordinate m error mean 4:",np.mean(exp4[8][200:3000]))
    print("Image coordinate m error std.dev 4:",np.std(exp4[8][200:3000]))   

    #Distance mean and std. dev
    print("Distance mean 1:",np.mean(exp1[11][200:3000]))
    print("Distance std.dev 1:",np.std(exp1[11][200:3000]))

    print("Distance mean 2:",np.mean(exp2[11][200:3000]))
    print("Distance std.dev 2:",np.std(exp2[11][200:3000]))

    print("Distance mean 3:",np.mean(exp3[11][200:3000]))
    print("Distance std.dev 3:",np.std(exp3[11][200:3000]))

    print("Distance mean 4:",np.mean(exp4[11][200:3000]))
    print("Distance std.dev 4:",np.std(exp4[11][200:3000]))

    #Angle mean and std. dev
    print("Angle mean 1:",np.mean(exp1[12][200:3000]))
    print("Angle std.dev 1:",np.std(exp1[12][200:3000]))

    print("Angle mean 2:",np.mean(exp2[12][200:3000]))
    print("Angle std.dev 2:",np.std(exp2[12][200:3000]))

    print("Angle mean 3:",np.mean(exp3[12][200:3000]))
    print("Angle std.dev 3:",np.std(exp3[12][200:3000]))

    print("Angle mean 4:",np.mean(exp4[12][200:3000]))
    print("Angle std.dev 4:",np.std(exp4[12][200:3000]))
    ...
    figure, axis = plt.subplots(1, 2)
    axis[0].plot(exp1[0][:3000],exp1[11][:3000],label="Camera-only",color = "blue")
    axis[0].plot(exp2[0][:3000],exp2[11][:3000],label="Lidar-only",color = "red")
    axis[0].plot(exp3[0][:3000],exp3[11][:3000],label="Filtered",color = "green")
    axis[0].plot(exp4[0][:3000],exp4[11][:3000],label="Complete",color = "orange")
    axis[0].set_xlabel("Time in seconds")
    axis[0].set_ylabel("Relative distance in m")
    axis[0].set_title("Distance between leader and follower")
    axis[0].legend()

    axis[1].plot(exp1[0][:3000],exp1[12][:3000],label="Camera-only",color = "blue")
    axis[1].plot(exp2[0][:3000],exp2[12][:3000],label="Lidar-only",color = "red")
    axis[1].plot(exp3[0][:3000],exp3[12][:3000],label="Filtered",color = "green")
    axis[1].plot(exp4[0][:3000],exp4[12][:3000],label="Complete",color = "orange")
    axis[1].set_xlabel("Time in seconds")
    ...
    plt.plot(exp1_pos[8][:3000],exp1_pos[9][:3000],label="Camera-only",color = "blue")
    plt.plot(exp2_pos[8][:3000],exp2_pos[9][:3000],label="Lidar-only",color = "red")
    plt.plot(exp3_pos[8][:3000],exp3_pos[9][:3000],label="Filtered",color = "green")
    plt.plot(exp4_pos[8][:3000],exp4_pos[9][:3000],label="Complete",color = "orange")
    ...
    plt.plot(exp2_pos[0][:3000],pos_error_rms2[:3000],label="Lidar-only",color = "red")
    plt.plot(exp3_pos[0][:3000],pos_error_rms3[:3000],label="Filtered",color = "green")
